...
# ---------- TRAIN ----------
        ...
        if df is not None:
            ...
            col1, col2 = st.columns(2)
            epochs_to_train = col1.slider("Training Epochs", min_value=1, max_value=30, value=10, step=10)
            learning_rate = col2.selectbox("Learning Rate", [0.01, 0.005, 0.001, 0.0001,1,2,5], index=1)
